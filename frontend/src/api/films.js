...
// 配色：想看 = 品牌靛蓝，在看 = 琥珀，看过 = 翠绿，弃了 = 中性灰（不是错误，不用红），没看过 = 浅石色（确认没看过，区别于未标记）
export const WATCH_STATUS_OPTIONS = [
  ...
  { value: 'unseen', label: '没看过', color: 'bg-stone-300 text-stone-700', active: 'bg-stone-400 text-white border-stone-400' },
]
