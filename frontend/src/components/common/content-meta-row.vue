...
<template>
  <div class="flex items-center justify-between text-[11px] text-slate-400">
    ...
    <div class="flex items-center gap-1.5 shrink-0">
      <span v-if="viewCount > 0" class="hidden md:inline-flex items-center gap-0.5">
      ...
      <template v-if="favoritedAt">
        <span v-if="viewCount > 0" class="hidden md:inline text-slate-200">&middot;</span>
        <span class="hidden md:inline-flex items-center gap-0.5">
