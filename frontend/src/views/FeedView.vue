        ...
        <div v-else-if="detailContent" class="flex-1 min-w-0 flex flex-col">
          <div ref="rightPanelRef" class="flex-1 overflow-y-auto overflow-x-hidden p-6 space-y-6">
            ...
            <div>
              ...
              <button
                v-if="detailContent.url"
                class="mt-3 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                :class="enriching
