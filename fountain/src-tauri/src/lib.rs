...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::credentials::open_douban_webview,
            commands::credentials::capture_douban_cookies,
            commands::credentials::validate_douban_cookie,
            commands::credentials::open_zhihu_webview,
            commands::credentials::capture_zhihu_cookies,
            commands::credentials::validate_zhihu_cookie,
            commands::credentials::validate_github_token,
            commands::credentials::open_twitter_webview,
