...
from app.api.routes import dashboard, sources, content, pipelines, templates, video, video_sync, audio, media, ebook, ebook_sync, sync, system_settings, prompt_templates, finance, credentials, opml, export as export_router, bilibili_auth
...
app.include_router(video_sync.router, prefix="/api/video", tags=["video"])
